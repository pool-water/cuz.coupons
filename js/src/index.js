...
import { TopoPage } from "./pages/05-topo.js";
...
function Init(seed) {
  ...
  PAGES[4] = new TopoPage(document.getElementById("page-05"), seed);
...
window.addEventListener("load", () => {
  ...
  function handleScroll() {
    const v = interpolat3([255, 165, 0], [255, 255, 255], getScrollPercent());
    const c = "rgb(" + v.join(", ") + ")";
